<template>
  <div class="min-h-screen bg-[#e0ecf2] flex flex-col items-center justify-center px-4 relative overflow-hidden">
    ...
    <div class="max-w-[1200px] w-full flex flex-col items-center text-center relative z-10">
      ...
      <div class="mb-12 animate-float">
        <NuxtImg 
          ...
          alt="Medaltea Panda" 
          class="w-48 lg:w-64 h-auto drop-shadow-2xl"
          width="256"
          height="256"
        />
      </div>
      ...
      <!-- Content -->
      <h1 class="text-4xl lg:text-7xl font-normal font-unbounded text-[#012828] mb-8 leading-tight">
        Cette fonctionnalité <br />
        <span class="text-[#EC7F7A]">arrive bientôt</span>
      </h1>
      
      <p class="text-lg lg:text-xl text-[#012828]/70 font-sans max-w-[600px] mb-12">
